package com.picker.yhck.pickerview.view;

import android.graphics.Typeface;
import android.view.View;
import com.picker.yhck.pickerview.adapter.ArrayWheelAdapter;
import com.picker.yhck.pickerview.lib.WheelView;
import com.picker.yhck.pickerview.listener.OnItemSelectedListener;
...
public class WheelOptions<T> {
    ...
    public void setPicker(List<T> options1Items,
        ...
        wheelListener_option2 = new OnItemSelectedListener() {
            ...
            @Override
            public void onItemSelected(int index) {
                if (mOptions3Items != null && mOptions2Items != null) {
